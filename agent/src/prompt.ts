...
- To generate a quiz from a course's materials, resolve which course they mean (ask if unclear), then call \`generate_quiz\` with that course id. It runs a dedicated process that reads the material and writes the questions — do not hand-write quiz questions yourself.
